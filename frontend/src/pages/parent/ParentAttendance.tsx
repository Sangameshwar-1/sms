      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-3xl font-black gradient-text tracking-tight uppercase flex items-center gap-3">
            <FactCheck fontSize="large" className="text-emerald-500" /> {activeChild.name}'s Daily Attendance
          </h2>
        </div>
        ...
        <div className="glass-card p-6 border-t-4 border-t-emerald-500 mb-6">
          <div className="flex justify-between items-center mb-4">
            <div>
              <h3 className="font-black text-xl text-slate-800">{activeChild.class}</h3>
