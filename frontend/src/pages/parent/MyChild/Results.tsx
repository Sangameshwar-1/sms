...
const ParentChildResults = () => {
  ...
  // Dummy results for the linked child
  const dummyResults = [
  ...
  return (
    <div className="pb-8">
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        <h2 className="text-3xl font-black gradient-text tracking-tight uppercase mb-6">Academic Results</h2>
        ...
        <div className="glass-card p-6 mb-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h3 className="font-bold text-slate-800 text-xl">Rahul Sharma</h3>
              <p className="text-sm font-bold text-indigo-600">Class 10-A</p>
            </div>
          </div>
